...
* FEATURE: [vmagent](https://docs.victoriametrics.com/vmagent/): show only unhealthy targets if `show_only_unhealthy` filter is enabled. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/3536).
