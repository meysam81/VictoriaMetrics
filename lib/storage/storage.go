...
// shouldDeleteMissingMetricID checks if metricID index entry is broken
// and should be deleted by caller
...
func (s *Storage) shouldDeleteMissingMetricID(metricID uint64) bool {
	...
	// Cannot find the MetricName/tsid for the given metricID for the last 60 seconds.
